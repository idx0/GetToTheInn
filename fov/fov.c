...
FOV_DEFINE_OCTANT(+,+,x,y,p,p,n,FOV_TRUE,FOV_TRUE)
FOV_DEFINE_OCTANT(+,+,y,x,p,p,y,FOV_TRUE,FOV_FALSE)
FOV_DEFINE_OCTANT(+,-,x,y,p,m,n,FOV_FALSE,FOV_TRUE)
FOV_DEFINE_OCTANT(+,-,y,x,p,m,y,FOV_FALSE,FOV_FALSE)
FOV_DEFINE_OCTANT(-,+,x,y,m,p,n,FOV_TRUE,FOV_TRUE)
FOV_DEFINE_OCTANT(-,+,y,x,m,p,y,FOV_TRUE,FOV_FALSE)
FOV_DEFINE_OCTANT(-,-,x,y,m,m,n,FOV_FALSE,FOV_TRUE)
FOV_DEFINE_OCTANT(-,-,y,x,m,m,y,FOV_FALSE,FOV_FALSE)
